...
**모바일로 보기 위해 만든 웹앱**입니다. 데스크탑에서도 그대로 동작하지만,
제가 폰으로 쓰고 싶어서 만든 것이라 좁은 화면을 먼저 맞췄습니다.

날씨 앱은 이미 많은데 굳이 하나 더 만든 이유는, 폰으로 날씨를 볼 때
기온 숫자보다 먼저 알고 싶은 게 따로 있어서였습니다 — 오늘 뭐 입지, 뭐 듣지.

그래서 세 가지를 앞에 뒀습니다.

- 📍 **GPS 로 지금 있는 곳부터** — 도시를 고르기 전에 현재 위치에서 가장 가까운 곳을 띄웁니다
- 👕 **기온에 맞는 옷차림** — 기상청 생활기상지수의 체감온도 구간을 그대로 옮겼습니다
- 🎵 **날씨에 맞는 플레이리스트** — 하늘을 여섯 갈래로 나눠 갈래마다 곡을 걸어 뒀습니다

기온 · 예보 같은 기본도 물론 다 있습니다. 다만 그건 이미 잘 하는 앱이 많으니,
**"보고 나서 뭘 할지"** 를 한 화면에서 끝내는 데 무게를 뒀습니다.

수업에서 배운 문법 안에서만 만들었고 부족한 곳이 많습니다.
어디까지가 과제이고 어디부터가 취향인지는 아래 `IV. 구현한 기능 목록` 에 나눠 적었습니다.
